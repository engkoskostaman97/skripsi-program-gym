      ...
      <div class="row">
        <div class="col-md-5 col-md-push-7">
          <div class="banner_content">
            <h1 style='text-shadow: -1px -1px 0 #000, 1px -1px 0 #000, -1px 1px 0 #000, 1px 1px 0 #000;'>Memberhsip Gym Predator </h1>
            <p><span style='text-shadow: -1px -1px 0 #000, 1px -1px 0 #000, -1px 1px 0 #000, 1px 1px 0 #000;'><b>Penuhi Kebutuhan Gaya Hidup Sehat dengan Berolahraga Di Gym Predator</b></span> </p>
...
<div class="car-info-box"> <a href="vehical-details.php?vhid=<?php echo htmlentities($result->id);?>"><img src="assets/images/bambel.jpg" class="img-responsive" alt="image"></a>
<ul>
