...
if($ckonf['jl']>0){
	...
	echo '  <li><a href="#"><i class="icon-users" style="width:30px"></i>Kelola Website '.$nt.'</a>
          <ul>
     ...
     echo '  <li><a href="#"><i class="icon-users" style="width:30px"></i>Kelola User</a>
          <ul>
		 ...
		 if ($_SESSION['levelmembership']=="admin"){
		 echo '<li><a href="#"><i class="icon-price-tag3" style="width:30px"></i>Kelola Paket</a>
          <ul>
      ...
      echo ' <li><a href="#"><i class="icon-users" style="width:30px"></i>Member</a>
		  ...
		  if ($_SESSION['levelmembership']=="admin"){
			    echo ' <li><a href="#"><i class="icon-user-tie" style="width:30px"></i>Kelola Trainer</a>
          <ul>
		...
		<li><a href="#"><i class="icon-enter3" style="width:30px"></i>Visit/Privat Training</a>
		 ...
		 if ($_SESSION['levelmembership']=="owner" || $_SESSION['levelmembership']=="manajer" || $_SESSION['levelmembership']=="kontrol transaksi"){
               echo ' <li><a href="#"><i class="icon-printer" style="width:30px"></i>Laporan</a>
          <ul>
		...
		if ($_SESSION['levelmembership']=="owner" || $_SESSION['levelmembership']=="manajer" || $_SESSION['levelmembership']=="kontrol transaksi" || $_SESSION['levelmembership']=="member"){
		echo '
