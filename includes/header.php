    ...
    <div class="container">
      <div class="row">
        <div class="col-sm-1 col-md-2">
          <div class="logo"> <a href="index.php"><img src="assets/images/large2.png" alt="image" height="100" width="130"/></a> </div>
        </div>
        <div class="col-sm-9 col-md-10">
          <div class="header_info">
            <div class="header_widgets">
              ...
              <a href="mailto:info@example.com">gympredator@gmail.com</a></div>
            <div class="header_widgets">
              <div class="circle_icon"> <i class="fa fa-phone" aria-hidden="true"></i> </div>
              <p class="uppercase_text">Call Center: </p>
              <a href="tel:61-1234-5678-09">+62-812-8575-211</a> </div>
            <div class="social-follow">
              <ul>
                 <li><a href="https://www.facebook.com/groups/1681795205311787"><i class="fa fa-facebook-square" aria-hidden="true"></i></a></li>
              <li><a href="https://www.instagram.com/zerotech__/"><i class="fa fa-instagram" aria-hidden="true"></i></a></li>
              </ul>
            </div>
   <?php
error_reporting(0);
   if(strlen($_SESSION['login'])==0)
	{	
?><div class="login_btn"><p><a href="#loginform" class="btn btn-xs uppercase" data-toggle="modal" data-dismiss="modal">Login / Register</a> </p></div>
<?php }
else{ 
...
{  
	 echo " ".htmlentities($result['nama']); }}?><i class="fa fa-angle-down" aria-hidden="true"></i></a>
 ...
 -->            
      ...
      <div class="collapse navbar-collapse" id="navigation">
        <ul class="nav nav-pills">
          ...
          <li><a href="page.php?type=baju">Merchandise</a></li>
