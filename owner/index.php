...
<img id="reflection" src="images/key.png" width="70px" height="70px"/></br></br></br>
<form action="loginowner/aksilogin.php" method="POST">
<table border=0>
<tr>
...
<head>
  ...
  <title> GYM PREDATOR | Owner</title>
...
<body>
  <div id="w">
    <div id="papanpanel">
	    <span class='headerteks'><i>Membership Gym Predator</i></span>
	</div>    
	<?php 
