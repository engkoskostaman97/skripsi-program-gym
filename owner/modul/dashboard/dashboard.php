...
}elseif ($_SESSION['levelmembership']=="owner"){?>
...
<td><div id='navigationadmin'><a href='index.php?modul=member&aksi=tampil'><img src='images/data.png' width='80px' title='Data Member' height='80px'/></a></br></br>Data Member</div></td>
<?php } ?>
<td><div id='navigationadmin'><a href='loginowner/aksilogout.php'><img src='images/logot.png' title='Keluar Dari Sistem' width='80px' height='80px'/></a></br></br>Logout</div></td>
</tr>
</table></br>-->
            </div>
			</span>
